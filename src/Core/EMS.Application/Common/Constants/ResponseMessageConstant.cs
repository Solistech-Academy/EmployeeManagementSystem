namespace EMS.Application.Common.Constants
{
    public class ResponseMessageConstant
    {
        ...
        public const string EMPLOYEE_DEACTIVATE_FAIL_MESSAGE = "Employee already deActive";
        public const string EMPLOYEE_DEACTIVATE_SUCCESS_MESSAGE = "Employee deActivated successfully.";
